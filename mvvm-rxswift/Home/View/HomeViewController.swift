...
class HomeViewController: UIViewController {
    ...
    private lazy var albumsViewController: AlbumsCollectionViewController = {
        ...
        var viewController = storyboard.instantiateViewController(withIdentifier: "AlbumsCollectionViewController") as! AlbumsCollectionViewController
    ...
    private lazy var tracksViewController: TracksTableViewController = {
        ...
        // Instantiate View Controller
        var viewController = storyboard.instantiateViewController(withIdentifier: "TracksTableViewController") as! TracksTableViewController
